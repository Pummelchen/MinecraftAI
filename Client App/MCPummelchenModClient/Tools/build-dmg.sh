...
VERSION="${PUMMELCHEN_CLIENT_VERSION:-0.8.2}"
...
install_name_tool -change "$DUCKDB_INSTALL_NAME" "@rpath/libduckdb.dylib" "$MACOS_DIR/MCPummelchenModClient"
install_name_tool -change "$DUCKDB_INSTALL_NAME" "@rpath/libduckdb.dylib" "$MACOS_DIR/pummelchen-client-sync"
install_name_tool -add_rpath "@executable_path/../Frameworks" "$MACOS_DIR/MCPummelchenModClient"
